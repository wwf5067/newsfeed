...
var trackerEntityLexicon = []trackerLexiconEntry{
	...
	{Label: "520", Category: "event", Aliases: []string{"520", "五二零"}},
	{Label: "情人节", Category: "event", Aliases: []string{"情人节", "214", "七夕"}},
	{Label: "母亲节", Category: "event", Aliases: []string{"母亲节"}},
	{Label: "父亲节", Category: "event", Aliases: []string{"父亲节"}},
	{Label: "中秋节", Category: "event", Aliases: []string{"中秋节", "中秋"}},
	{Label: "端午节", Category: "event", Aliases: []string{"端午节", "端午"}},
	{Label: "元宵节", Category: "event", Aliases: []string{"元宵节", "元宵"}},
	{Label: "清明节", Category: "event", Aliases: []string{"清明节", "清明"}},
	{Label: "劳动节", Category: "event", Aliases: []string{"劳动节", "五一"}},
	{Label: "圣诞节", Category: "event", Aliases: []string{"圣诞节", "圣诞", "平安夜"}},
