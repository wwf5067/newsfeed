          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {data.is_heat_discovered && (
                data.is_promoted
                  ? <span className="rounded bg-emerald-100 px-1.5 py-0.5 text-[10px] font-bold uppercase text-emerald-700 dark:bg-emerald-900 dark:text-emerald-300">N</span>
                  : <span className="rounded bg-blue-100 px-1.5 py-0.5 text-[10px] font-bold uppercase text-blue-700 dark:bg-blue-900 dark:text-blue-300">N</span>
              )}
              {data.is_heat_discovered && (
                <button
                  type="button"
